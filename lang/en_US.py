STRINGS = {
    ...
    "bot.update_no_changelog": "I have updated to version **{0}**! Visit https://github.com/aindasouoGustavo/Rem Bot/releases for the full changelog.",
    "bot.usage": "Usage",
    ...
    "general.err.cannot_get_changelog": "There was an error fetching the changelog. Visit https://github.com/aindasouoGustavo/Rem Bot/releases to see all releases.",
